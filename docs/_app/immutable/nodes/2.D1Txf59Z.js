 ...
 * OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.
 *
 */let t=$(e,["$$slots","$$events","$$legacy"]);const r=[["path",{d:"M18 6 6 18"}],["path",{d:"m6 6 12 12"}]];re(a,te({name:"x"},()=>t,{get iconNode(){return r},children:(l,n)=>{var i=j(),s=G(i);F(s,()=>e.children??Q),C(l,i)},$$slots:{default:!0}})),z()}function Vt(a,e,t){de(e,[0,0,0,0,0],!0),de(t,0)}function zt(a,e,t,r,l){E(e)||t(r,E(l)),de(e,!E(e))}var Jt=L("<pre> </pre>"),Wt=L("<pre> </pre>"),jt=L("<pre> </pre>"),Yt=L("<button><!></button>"),Ut=L('<div class="card w-full max-w-md preset-filled-surface-100-900 p-4 text-center">code to crack: <div class="flex flex-row"></div> <div class="flex flex-row"></div> <hr class="hr border-t-4 border-stone-500 m-1"/> <div class="card w-full max-w-md bg-stone-400 preset-filled-surface-100-900 p-4 text-center"><pre class="pre">instructions</pre> <div class="flex flex-row"></div> <div class="flex flex-row"><button><!></button> <button><!></button> <button><!></button> <button><!></button></div></div> <div class="flex flex-row"><!> <!> <!> <button><!></button></div></div>');function qt(a,e){V(e,!0);let t=Ne([{operator:"x",relative:null,absolute:null},{operator:"m",relative:1,absolute:null},{operator:"a",relative:null,absolute:4}]),r=we(0),l=Ne([{operator:"x",relative:null,absolute:null},{operator:"m",relative:3,absolute:null},{operator:"a",relative:null,absolute:4},{operator:"m",relative:3,absolute:null},{operator:"x",relative:null,absolute:null},{operator:"m",relative:1,absolute:null}]),n=Ne([0,0,0,0,0]),i=we(Ne([0,0,0,0,0])),s=we(!1);v(l,n,!0);async function v(M,T,B){for(let P=0;P<M.length;P++){let U=0;switch(M[P].relative!=null?U=(E(r)+M[P].relative)%n.length:U=M[P].absolute%n.length,M[P].operator){case"x":T[E(r)]^=1;break;case"m":de(r,U,!0);break;case"a":T[E(r)]&=T[U];break;case"o":T[E(r)]|=T[U];break}await new Promise(he=>setTimeout(he,200))}B&&de(r,0),de(s,!1)}var o=Ut(),g=D(I(o));Ee(g,21,()=>E(i),pe,(M,T,B)=>{var P=Jt(),U=I(P,!0);k(P),ae(()=>{Z(P,1,`pre m-auto ${B==E(r)?"bg-red-400":""}`),xe(U,E(T))}),C(M,P)}),k(g);var b=D(g,2);Ee(b,21,()=>n,pe,(M,T,B)=>{var P=Wt(),U=I(P,!0);k(P),ae(()=>{Z(P,1,`pre m-auto ${B==E(r)?"bg-blue-400":""}`),xe(U,E(T))}),C(M,P)}),k(b);var d=D(b,4),A=D(I(d),2);Ee(A,21,()=>t,pe,(M,T)=>{var B=jt();Z(B,1,"pre m-auto");var P=I(B,!0);k(B),ae(()=>xe(P,E(T).operator+(E(T).relative!=null?`{${E(T).relative}}`:E(T).absolute!=null?`[${E(T).absolute}]`:""))),C(M,B)}),k(A);var u=D(A,2),h=I(u);h.__click=add_insn;var N=I(h);Gt(N,{class:"x-insn"}),k(h);var m=D(h,2);m.__click=add_insn;var y=I(m);It(y,{}),k(m);var x=D(m,2);x.__click=add_insn;var w=I(x);St(w,{}),k(x);var p=D(x,2);p.__click=add_insn;var _=I(p);Ht(_,{}),k(p),k(u),k(d);var c=D(d,2),S=I(c);Rt(S,{});var J=D(S,2);{var le=M=>{Bt(M,{})},Y=M=>{var T=Yt();T.__click=[zt,s,v,t,i];var B=I(T);Dt(B,{}),k(T),C(M,T)};se(J,M=>{E(s)?M(le):M(Y,!1)})}var H=D(J,2);Ft(H,{});var K=D(H,2);K.__click=[Vt,i,r];var X=I(K);Lt(X,{}),k(K),k(c),k(o),C(a,o),z()}We(["click"]);var Kt=L('<pre class="pre">options o algo</pre>');function Xt(a){var e=Kt();C(a,e)}var Zt=L("<!> <!>",1),Qt=L('<div class="card bg-stone-900 border-surface-100-900 flex h-screen w-full flex-col border-[1px]"><!> <div class="flex flex-col items-center justify-center h-full"><!></div></div>');function lr(a){let e=we("home");var t=Qt(),r=I(t);Oe(r,()=>He.Bar,(v,o)=>{o(v,{get value(){return E(e)},onValueChange:g=>de(e,g,!0),children:(g,b)=>{var d=Zt(),A=G(d);Oe(A,()=>He.Tile,(h,N)=>{N(h,{id:"home",label:"Home",children:(m,y)=>{Ot(m,{})},$$slots:{default:!0}})});var u=D(A,2);Oe(u,()=>He.Tile,(h,N)=>{N(h,{id:"options",label:"Options",children:(m,y)=>{Pt(m,{})},$$slots:{default:!0}})}),C(g,d)},$$slots:{default:!0}})});var l=D(r,2),n=I(l);{var i=v=>{qt(v,{})},s=v=>{var o=j(),g=G(o);{var b=d=>{Xt(d)};se(g,d=>{E(e)=="options"&&d(b)},!0)}C(v,o)};se(n,v=>{E(e)=="home"?v(i):v(s,!1)})}k(l),k(t),C(a,t)}export{lr as component};
